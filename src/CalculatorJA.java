...
public class CalculatorJA extends JApplet{
	...
	public void init(){
	 ...
	 // Create the panel with the GridLayout with 12 buttons – 
        //10 numeric ones, period, and the equal sign   
		  ...
		  p1 = new JPanel();
		  GridLayout glc =new GridLayout(4,3); 
		  p1.setLayout(glc);
	 ...
	 //  Add window controls to the panel p1
		  ...
		  CalculatorJAEngine calcEngine = new CalculatorJAEngine(this);
	...
	// Add the panel p1 to the center of the window				          
         ...
         p2 = new JPanel();
         GridLayout gle =new GridLayout(4,1); 
		 p2.setLayout(gle);
